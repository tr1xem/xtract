...
logging.basicConfig(
    filename='image_processing.log',  # Log file name
...
def arrange_images_on_a4(input_folder):
    ...
    padding_x = 10  # Horizontal padding between images
    padding_y = 10  # Vertical padding between images
    
    occupied_areas = []  # List to keep track of occupied areas on the A4 sheet
    ...
    for image_file in image_files:
        ...
        # Try to find a position for this image on the A4 sheet
        ...
        # If we couldn't place it on this page
        if not placed:
            ...
            occupied_areas.clear()  # Clear occupied areas for new page
            
            # Try placing this image again on the new page
            attempt_y=50   # Reset y position for new page 
